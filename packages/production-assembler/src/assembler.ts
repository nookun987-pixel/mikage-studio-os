import {
  ...
  type PackageDecisionShell,
  type ProductionPackageInput,
  type ProductionPackageResult
} from '@mikage/contracts';

const buildDecision = (input: ProductionPackageInput): PackageDecisionShell => {
...
export const assembleProductionPackage = (
  rawInput: ProductionPackageInput
  ...
  return productionPackageResultSchema.parse({
    ...
    promptBundle: {
      ...
      negativePrompt:
        input.negativePromptReference.negativePrompt.rendered || 'none',

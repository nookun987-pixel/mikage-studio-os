...
export const silverBenchmarkShellSchema =
  benchmarkComparisonShellBaseSchema.extend({
...
export type BenchmarkSetReferenceShell = z.infer<
  typeof benchmarkSetReferenceShellSchema
>;

...
export type CompiledPromptReferenceShell = z.infer<
  typeof compiledPromptReferenceShellSchema
>;
export type ValidationReferenceShell = z.infer<
  typeof validationReferenceShellSchema
>;
export type NegativePromptReferenceShell = z.infer<
  typeof negativePromptReferenceShellSchema
>;
export type LineageReferenceShell = z.infer<typeof lineageReferenceShellSchema>;
export type BenchmarkAuditPlaceholderShell = z.infer<
  typeof benchmarkAuditPlaceholderShellSchema
>;
...
export type ProductionPackageRequest = z.infer<
  typeof productionPackageRequestSchema
>;
export type PackageSummaryShell = z.infer<typeof packageSummaryShellSchema>;
export type ProductionPackageResult = z.infer<
  typeof productionPackageResultSchema
>;

 ...
 */
import { createEvaluationScore, createEvaluationWarning, createEvaluationNote } from "./evaluation-types.js";
import { evaluateImageQuality, evaluateTextQuality, evaluatePromptAlignment, evaluateArtifactRisk } from "./evaluation-rules.js";
export class DefaultEvaluationEngine {
    rules = new Map();
    enabledRules = new Set();
    constructor() {
        this.initializeDefaultRules();
    }
    async evaluateGeneration(context) {
        const results = [];
        const allFlags = [];
        const allWarnings = [];
        const allNotes = [];
